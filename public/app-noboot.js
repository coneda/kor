...
window.wApp = {
    ...
    setup: function() {
        ...
        return Promise.all([ wApp.session.setup(), wApp.config.setup(), wApp.i18n.setup(), wApp.info.setup() ]);
    }
};
