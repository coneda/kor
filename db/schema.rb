...
ActiveRecord::Schema[7.0].define(version: 2022_02_21_080258) do
  create_table "authority_group_categories", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "authority_groups", id: :integer, charset: "utf8", force: :cascade do |t|
    t.integer "lock_version", default: 0
    t.string "name"
    t.string "uuid"
    t.datetime "created_at", precision: nil
  ...
  create_table "authority_groups_entities", id: false, charset: "utf8", force: :cascade do |t|
    t.integer "entity_id"
  ...
  create_table "credentials", id: :integer, charset: "utf8", force: :cascade do |t|
    t.string "name"
    t.text "description"
    t.integer "lock_version", default: 0
  ...
  create_table "credentials_users", id: false, charset: "utf8", force: :cascade do |t|
    t.integer "user_id"
    t.integer "credential_id"
  ...
  create_table "directed_relationships", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "entities", id: :integer, charset: "utf8", force: :cascade do |t|
    t.string "uuid"
    t.string "name"
  ...
  create_table "entities_system_groups", id: false, charset: "utf8", force: :cascade do |t|
    t.integer "entity_id"
  ...
  create_table "entities_tags", id: false, charset: "utf8", force: :cascade do |t|
    t.integer "entity_id"
    t.integer "tag_id"
    t.index ["entity_id", "tag_id"], name: "index_entities_tags_on_entity_id_and_tag_id", unique: true
  end

  create_table "entities_user_groups", id: false, charset: "utf8", force: :cascade do |t|
    t.integer "entity_id"
  ...
  create_table "entity_datings", id: :integer, charset: "utf8", force: :cascade do |t|
    t.integer "lock_version", default: 0
    t.integer "entity_id"
    t.string "label"
  ...
  create_table "identifiers", id: :integer, charset: "utf8", force: :cascade do |t|
    t.string "kind"
    t.string "value"
    t.datetime "created_at", precision: nil
    t.datetime "updated_at", precision: nil
  ...
  create_table "kinds", id: :integer, charset: "utf8", force: :cascade do |t|
    t.string "uuid"
    t.string "name"
    t.text "description"
    t.text "settings"
  ...
  create_table "publishments", id: :integer, charset: "utf8", force: :cascade do |t|
    t.integer "user_id"
    t.string "uuid"
    t.string "name"
  ...
  create_table "relations", id: :integer, charset: "utf8", force: :cascade do |t|
    t.string "uuid"
    t.string "name"
  ...
  create_table "system_groups", id: :integer, charset: "utf8", force: :cascade do |t|
    t.integer "lock_version", default: 0
    t.string "name"
    t.string "uuid"
    t.datetime "created_at", precision: nil
