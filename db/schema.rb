...
ActiveRecord::Schema.define(version: 20211104071852) do
  ...
  create_table "authority_group_categories", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "authority_groups", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "lock_version", default: 0
    t.string "name"
    t.string "uuid"
    t.datetime "created_at"
  ...
  create_table "collections", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "lock_version", default: 0
    t.string "name"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "collections_credentials", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "credentials", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "name"
    t.text "description"
    t.integer "lock_version", default: 0
  ...
  create_table "directed_relationships", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "downloads", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "user_id"
    t.string "uuid"
    t.string "file_name"
  ...
  create_table "entity_datings", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "lock_version", default: 0
    t.integer "entity_id"
    t.string "label"
  ...
  create_table "generators", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "kind_id"
    t.string "name"
    t.text "directive"
    t.datetime "created_at", null: false
  ...
  create_table "identifiers", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "kind"
    t.string "value"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "kinds", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "uuid"
    t.string "name"
    t.text "description"
    t.text "settings"
  ...
  create_table "publishments", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "user_id"
    t.string "uuid"
    t.string "name"
  ...
  create_table "relations", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "uuid"
    t.string "name"
  ...
  create_table "relationship_datings", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "relationship_id"
    t.string "label"
    t.string "dating_string"
    t.integer "from_day"
  ...
  create_table "system_groups", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "lock_version", default: 0
    t.string "name"
    t.string "uuid"
    t.datetime "created_at"
  ...
  create_table "user_groups", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "lock_version", default: 0
    t.integer "user_id"
    t.string "name"
    t.string "uuid"
