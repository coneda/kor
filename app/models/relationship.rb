class Relationship < ApplicationRecord
  ...
  belongs_to :from, class_name: "Entity", foreign_key: :from_id, optional: true
  belongs_to :to, class_name: "Entity", foreign_key: :to_id, optional: true

  belongs_to :normal, class_name: "DirectedRelationship", dependent: :destroy, autosave: true, optional: true
  belongs_to :reversal, class_name: "DirectedRelationship", dependent: :destroy, autosave: true, optional: true
