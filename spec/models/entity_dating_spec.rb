...
RSpec.describe EntityDating do
  ...
  it "should not save if dating_string can't be parsed" do
    dating = FactoryBot.build(:entity_dating,
      dating_string: "Am Anfang vom 15. Jahrhundert wurde die Kirche gebaut"
    )
  ...
  it "should parse '1957 bis ?'" do
    ...
    expect(dating.from_day).to eq(2_435_840)
    expect(dating.to_day).to eq(2_438_030)
  end
end
