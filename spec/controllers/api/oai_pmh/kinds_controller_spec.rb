...
RSpec.describe Api::OaiPmh::KindsController, type: :request do
  include XmlHelper
  # render_views
  ...
  it "should respond to 'Identify'" do
    get '/api/oai-pmh/kinds.xml', verb: 'Identify'
    expect(response).to be_success
    expect{Hash.from_xml response.body}.not_to raise_error

    post '/api/oai-pmh/kinds.xml', verb: 'Identify'
    expect(response).to be_success
    expect{Hash.from_xml response.body}.not_to raise_error
  ...
  it "should respond to 'ListMetadataFormats'" do
    get '/api/oai-pmh/kinds.xml', verb: 'ListMetadataFormats'
    expect(response).to be_success
    expect{Hash.from_xml response.body}.not_to raise_error
  end

  it "should respond to 'ListIdentifiers'" do
    get '/api/oai-pmh/kinds.xml', verb: 'ListIdentifiers'
  ...
  it "should respond to 'ListRecords'" do
    get '/api/oai-pmh/kinds.xml', verb: 'ListRecords', metadataPrefix: 'kor'
