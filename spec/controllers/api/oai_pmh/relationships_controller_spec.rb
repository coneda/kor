...
RSpec.describe Api::OaiPmh::RelationshipsController, type: :request do
  include XmlHelper

  it "should respond to 'Identify'" do
    get '/api/oai-pmh/relationships.xml', verb: 'Identify'
    expect(response).to be_success
    expect{Hash.from_xml response.body}.not_to raise_error

    post '/api/oai-pmh/relationships.xml', verb: 'Identify'
    expect(response).to be_success
    expect{Hash.from_xml response.body}.not_to raise_error
  end

  it "should respond to 'ListMetadataFormats'" do
    get '/api/oai-pmh/relationships.xml', verb: 'ListMetadataFormats'
    expect(response).to be_success
    expect{Hash.from_xml response.body}.not_to raise_error
  end
  ...
  it "should respond to 'ListIdentifiers'" do
    ...
    get '/api/oai-pmh/relationships.xml', {
