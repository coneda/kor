...
RSpec.describe Api::OaiPmh::EntitiesController, type: :request do
  include XmlHelper
  ...
  it "should respond to 'Identify'" do
    get '/api/oai-pmh/entities.xml', verb: 'Identify'
    expect(response).to be_success
    expect{Hash.from_xml response.body}.not_to raise_error

    post '/api/oai-pmh/entities.xml', verb: 'Identify'
    expect(response).to be_success
    expect{Hash.from_xml response.body}.not_to raise_error
  end

  it "should respond to 'ListMetadataFormats'" do
    get '/api/oai-pmh/entities.xml', verb: 'ListMetadataFormats'
    expect(response).to be_success
    expect{Hash.from_xml response.body}.not_to raise_error
  end

  it "should respond to 'ListIdentifiers'" do
    get '/api/oai-pmh/entities.xml', verb: 'ListIdentifiers'
    expect(response).to be_success
    expect{Hash.from_xml response.body}.not_to raise_error
  end

  it "should respond to 'ListRecords'" do
    get '/api/oai-pmh/entities.xml', {
      verb: 'ListRecords',
      metadataPrefix: 'kor'
    }
    expect(response).to be_success
  ...
  specify "oai-pmh routes" do
    path = '/api/oai-pmh/entities.xml?verb=ListRecords'
  ...
  it "should return 'noSetHierarchy' if a set is requested" do
    get '/api/oai-pmh/entities.xml', verb: 'ListSets'
