...
Feature: datings
  ...
  Scenario: create an entity with a dating
    ...
    And I fill in "entity_new_datings_attributes__label" with "created in" within "#datings"
    And I fill in "entity_new_datings_attributes__dating_string" with "1503" within "#datings"
    And I press "Create"
  ...
  Scenario: create an entity with two datings
    ...
    And I fill in "entity_new_datings_attributes__dating_string" with "1503" within "#datings"
    And I click element "[data-name=plus]" within "#datings"
    And I fill in "entity_new_datings_attributes__label" with "revised in" within "#datings .ats .attachment:nth-child(2)"
    And I fill in "entity_new_datings_attributes__dating_string" with "1506" within "#datings .ats .attachment:nth-child(2)"
    And I press "Create"
    Then entity "Mona Lisa" should have dating "created in: 1503"
  ...
  Scenario: modify one of two datings
    ...
    And entity "Mona Lisa" has dating "destroyed in: 2017"
    When I go to the edit page for "entity" "Mona Lisa"
    And I fill in "entity_existing_datings_attributes__label" with "revised in" within "#datings .ats .attachment:nth-child(2)"
    And I fill in "entity_existing_datings_attributes__dating_string" with "1508" within "#datings .ats .attachment:nth-child(2)"
    And I press "Save"
    Then entity "Mona Lisa" should have dating "created in: 1503"
  ...
  Scenario: handling leap years
    ...
    And I fill in "entity_existing_datings_attributes__dating_string" with "29.2.1994" within "#datings .ats .attachment:nth-child(1)"
    And I press "Save"
