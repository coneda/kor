Feature: authority groups
  ...
  Scenario: Jump to authority group from entity page
    And I am logged in as "admin"
    And the authority group categories structure "semester 01 >> lectures"
    And the authority group categories structure "semester 02 >> seminars"
    And the authority group "icons" inside "lectures"
    And the authority group "colors" inside "seminars"
    And the authority group "project"
    And the entity "Mona Lisa" is in authority group "icons"
    And the entity "Mona Lisa" is in authority group "colors"
    And the entity "Mona Lisa" is in authority group "project"
    When I go to the entity page for "Mona Lisa"
    Then I should see link "semester 01"
    Then I should see link "semester 02"
    Then I should see link "lectures"
    Then I should see link "seminars"
    Then I should see link "icons"
    Then I should see link "colors"
    Then I should see link "project"
    And I should see "semester 01 / lectures / icons"
    And I should see "semester 02 / seminars / colors"
